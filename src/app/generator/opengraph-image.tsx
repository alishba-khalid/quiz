...
export const alt = "AI Worksheet & Quiz Generator — Free Studio | QuizKraft";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          AI Worksheet & Quiz Studio
        </div>

        <div style={{ fontSize: "26px", color: "#5F6C7B", marginBottom: "48px" }}>
          Custom printable worksheets and adaptive quizzes in 10 seconds.
        </div>
